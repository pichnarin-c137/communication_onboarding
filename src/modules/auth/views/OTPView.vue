  ...
  <div class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        <div
          class="inline-flex items-center justify-center w-16 h-16 bg-primary rounded-lg">
      ...
      <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
        ...
        <form @submit.prevent="handleVerify" class="space-y-5">
          <div>
            ...
            <input id="otp" v-model="otp" type="text" inputmode="numeric" maxlength="6" placeholder="Enter OTP"
          ...
          <button type="submit" :disabled="authStore.loading || otp.length < 6"
